...
public class RoundRobin {
    ...
    public static void main(String args[]) throws IOException{
        ...
        int CS_Counter = 0; //Context Switches counter
        System.out.println();
        ...
        if(i != 0){
            ...
            //the new Process
                ...
                CS_Counter++; //Increament the number of Context Switches
            }
        }
        ...
        System.out.println("The total number of Context Switches is: " + CS_Counter);
    }
}
